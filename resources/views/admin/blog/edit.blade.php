                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form id="form_subservice" method="POST" action="{{ route('blog.update',$blog->id) }}" enctype="multipart/form-data">
                            {{ method_field('PUT') }}
                            {{ csrf_field() }}
                                    ...
                                    <label class="form-label">Sub Categories</label>
                                        <select name="sub_category_id" id="edit_sub_category_id" class="form-control select2">
                                            ...
                                            @foreach($subcategory as $subcate)
                                                <option value="{{ $subcate->id }}" {{ old('sub_category_id',$blog->sub_category_id) == $subcate->id ? 'selected':''}}>{{ $subcate->title }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('title')) is-invalid @endif" name="title" value="{{old('title',$blog->title)}}">
                                        @if($errors->has('title'))
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="file" class="form-control  @if($errors->has('photo')) is-invalid @endif" name="photo" value="{{old('photo',$blog->photo)}}">
                                        @if($errors->has('photo'))
                                        ...
                                        @if(!empty($blog->photo) && File::exists(public_path("assets/images/blogimage/".$blog->photo)))
                                            <div class="mt-25">
                                                <img src="{{ asset('assets/images/blogimage') }}/{{ $blog->photo }}" class="rounded" width="100">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <textarea class="form-control @if($errors->has('details')) is-invalid @endif" name="details" id="description">{{old('details',$blog->details)}}</textarea>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('source')) is-invalid @endif" name="source" value="{{old('source',$blog->source)}}">
                                ...
                                <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" class="form-control @if($errors->has('author_name')) is-invalid @endif" name="author_name"  value="{{old('author_name',$blog->author_name)}}">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" data-role="tagsinput" name="tag" class="form-control @if($errors->has('tag')) is-invalid @endif" value="{{old('tag',$blog->tags)}}">
                                        @if($errors->has('tag'))
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (inedx, subcatObj) {
                ...
                select = "{{ old('sub_category_id',$blog->sub_category_id) }}";
                selected = select == subcatObj.id ? 'selected' : '';
