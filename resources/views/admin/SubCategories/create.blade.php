                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item">Add Sub Categories
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form id="form_validation" method="POST" action="{{ route('sub-categories.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                {{--<!-- <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('note')) is-invalid @endif" name="note" value="{{old('note')}}" >
                                        @if($errors->has('note'))
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('subnote')) is-invalid @endif" name="subnote" value="{{old('subnote')}}" >
