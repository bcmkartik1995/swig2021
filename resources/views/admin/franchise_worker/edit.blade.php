                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item">Edit Worker
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form id="franchise_worker" method="POST" action="{{ route('franchises-worker.update',$franchise_worker->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                    ...
                                    <div class="form-line">
                                        ...
                                        <select class="select-service form-control" name="service[]" id="p_service_id" multiple>
                                            @foreach($services as $service)
                                                <option value="{{ $service->service->id }}" {{ in_array($service->service_id ,old('service',$worker_service)) ? 'selected':'' }}>{{ $service->service->title }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('name')) is-invalid @endif" name="name" value="{{old('name',$franchise_worker->name)}}">
                                        @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('email')) is-invalid @endif" name="email" value="{{old('email',$franchise_worker->email )}}">
                                        @if($errors->has('email'))
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('mobile')) is-invalid @endif" name="mobile" value="{{old('mobile',$franchise_worker->mobile )}}">
