                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form id="form_validation" method="POST" action="{{ route('payments.update',$payments->id) }}" enctype="multipart/form-data">
                            {{ method_field('PUT') }}
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <select name="type" id="type" class="form-control select2">
                                                <option value="1" {{ old('type',$payments->type) == 1 ? 'selected':''}}>Debit</option>
                                                <option value="2" {{ old('type',$payments->type) == 2 ? 'selected':''}}>Credit</option>
                                            </select>
                                            @if($errors->has('type'))
                                    ...
                                    <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select class="form-control @if($errors->has('franchise_id')) is-invalid @endif select2" name="franchise_id">
                                                    ...
                                                    <option value="{{$f}}" {{ old('franchise_id',$payments->franchise_id) == $f ? 'selected':''}}>{{$franchise}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" class="form-control @if($errors->has('amount')) is-invalid @endif" name="amount" value="{{old('amount',$payments->amount)}}">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" class="form-control @if($errors->has('payment_date')) is-invalid @endif datepicker" name="payment_date" value="{{ old('payment_date',Carbon::parse( $payments->payment_date)->format('d/m/Y')) }}">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <textarea name="remarks" class="form-control @if($errors->has('remarks')) is-invalid @endif" id="" rows="5">{{old('remarks',$payments->remarks)}}</textarea>
