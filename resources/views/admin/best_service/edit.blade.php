                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item">Edit Best Services
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Best Services</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form id="form_best_service" method="POST" action="{{ route('best-service.update',$best_service->id) }}" enctype="multipart/form-data">
                                {{ method_field('PUT') }}
                                    {{ csrf_field() }}
                                        ...
                                        <div class="form-line">
                                            ...
                                            <select class="form-control select2" name="service_id" id="bs_service_id">
                                                ...
                                                @foreach($services as $service)
                                                    <option value="{{ $service->id }}" {{ $best_service->service_id == $service->id ? 'selected' : '' }}>{{ $service->title }}</option>
                                                @endforeach
                                            </select>
