                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('franchise-view') }}">Franchise</a>
                            </li>
                            <li class="breadcrumb-item">Edit Franchise
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form id="form_franchise" method="POST" action="{{ route('franchise-update',$franchise->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" class="form-control" id="lat1" name="area_lat1" value="{{old('area_lat1',$franchise->area_lat1)}}">
                                <input type="hidden" class="form-control" id="lng1" name="area_lng1" value="{{old('area_lng1',$franchise->area_lng1)}}">
                                <input type="hidden" class="form-control" id="lat2" name="area_lat2" value="{{old('area_lat2',$franchise->area_lat2)}}">
                                <input type="hidden" class="form-control" id="lng2" name="area_lng2" value="{{old('area_lng2',$franchise->area_lng2)}}">
...
<script>
var lat = {{!empty(old('latitude',$franchise->latitude)) ? old('latitude',$franchise->latitude) : 21.16486108042384}};
var lng = {{!empty(old('longitude',$franchise->longitude)) ? old('longitude',$franchise->longitude) : 72.83420567685027}};

var area_lat1 = "{{old('area_lat1',$franchise->area_lat1)}}";
var area_lng1 = "{{old('area_lng1',$franchise->area_lng1)}}";
var area_lat2 = "{{old('area_lat2',$franchise->area_lat2)}}";
var area_lng2 = "{{old('area_lng2',$franchise->area_lng2)}}";
if(area_lat1){
