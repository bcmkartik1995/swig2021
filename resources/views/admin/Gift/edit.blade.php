                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item">Edit Gift
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form id="form_gift" method="POST" action="{{ route('gift-card.update',$gifts->id) }}" enctype="multipart/form-data">
                            {{ method_field('PUT') }}
                           {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('title')) is-invalid @endif" name="title" value="{{old('title',$gifts->title)}}">
                                        @if($errors->has('title'))
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control @if($errors->has('gift_value')) is-invalid @endif" name="gift_value" value="{{old('gift_value',$gifts->gift_value)}}">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <textarea class="form-control @if($errors->has('description')) is-invalid @endif" name="description" id="description">{{old('description',$gifts->description)}}</textarea>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="file" class="form-control @if($errors->has('image')) is-invalid @endif" name="image" value="{{old('image',$gifts->image)}}">
                                        @if($errors->has('image'))
                                        ...
                                        @if(!empty($gifts->image) && File::exists(public_path("assets/images/giftsimage/".$gifts->image)))
                                            <div class="mt-25">
                                                <img src="{{ asset('assets/images/giftsimage') }}/{{ $gifts->image }}" class="rounded" width="100px">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="date" class="form-control @if($errors->has('valid_from')) is-invalid @endif" name="valid_from" value="{{old('valid_from',$gifts->valid_from)}}">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="date" class="form-control @if($errors->has('valid_to')) is-invalid @endif" name="valid_to" value="{{old('valid_to',$gifts->valid_to)}}">
