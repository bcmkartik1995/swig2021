                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form id="form_offer" method="POST" action="{{ route('offer.update',$offers->id) }}" enctype="multipart/form-data">
                                {{ method_field('PUT') }}
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="global_subCategory form-group">
                                            ...
                                            <label class="form-label">Sub Category</label>
                                                <select name="sub_category_id" id="o_sub_category_id" class="form-control select-box sub_cat_trigger">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="file" class="form-control @if($errors->has('banner')) is-invalid @endif" name="banner" value="{{old('banner',$offers->banner)}}">
                                                ...
                                                @if(!empty($offers->banner) && File::exists(public_path("assets/images/offerbanner/".$offers->banner)))
                                                    <div class="mt-25">
                                                        <img src="{{ asset('assets/images/offerbanner') }}/{{ $offers->banner }}" class="rounded" width="100px">
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <div class="checkbox">
                                                    ...
                                                    <input type="checkbox" name="is_user_specific" class="checkbox-input user_checkbox" id="checkbox2" value="{{old('is_user_specific',$offers->is_user_specific)}}" {{ $offers->is_user_specific == 1 ? 'checked' : '' }}>
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (inedx, subcatObj) {
                ...
                // selected_value = '{{ $offers->sub_category_id }}';
                // old_value = "{{ old('sub_category_id') }}";
                // selected = (old_value,selected_value)==subcatObj.id?'selected':'';
