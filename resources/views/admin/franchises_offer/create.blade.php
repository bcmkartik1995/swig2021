    ...
    <div class="content-wrapper">
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h5 class="content-header-title float-left pr-1 mb-0">Franchise Offer</h5>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active"><a href="{{ route('franchises-offer.index') }}">Franchise Offer</a>
                            </li>
                            <li class="breadcrumb-item">Add Franchise Offer
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Franchise Offer</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                            <form id="form_offer" method="POST" action="{{ route('franchises-offer.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
...
$('#o_sub_category_id').on('change', function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#o_service_id').empty();
            $('#o_service_id').append('<option value ="">Select Service</option>');
            $.each(data, function (inedx, subcatObj) {
                //console.log(subcatObj.title);
