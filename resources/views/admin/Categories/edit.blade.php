                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form id="form_category" method="POST" action="{{ route('categories.update',$categories->id) }}" enctype="multipart/form-data">
                                <input name="_method" type="hidden" value="PUT">
                                {{csrf_field()}}
                                <div class="form-group">
                                    <div class="form-line">
                                        <label class="form-label">Title</label>
                                        <input type="text" class="form-control @if($errors->has('title')) is-invalid @endif" name="title" value="{{old('title',$categories->title)}}">
                                        @if($errors->has('title'))
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="file" class="form-control @if($errors->has('logo')) is-invalid @endif" name="logo" value="{{old('logo',$categories->logo)}}">
                                        @if($errors->has('logo'))
                                        ...
                                        @if(!empty($categories->logo) && File::exists(public_path("assets/images/categorylogo/".$categories->logo)))
                                            <div class="mt-25">
                                                <img src="{{ asset('assets/images/categorylogo') }}/{{ $categories->logo }}" class="rounded" width="50">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <textarea class="form-control @if($errors->has('description')) is-invalid @endif" name="description" id="description">{{old('description',$categories->description)}}</textarea>
