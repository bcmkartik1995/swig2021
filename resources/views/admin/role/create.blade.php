    ...
    <div class="content-wrapper">
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h5 class="content-header-title float-left pr-1 mb-0">{{ __('Add Role') }} <!-- <a class="add-btn btn btn-dark mr-1" href="{{route('admin-role-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a> --></h5>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item">{{ __('Add Role') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                      ...
                      @include('includes.admin.form-both')
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-8 form-group">
                            <input type="text" class="input-field form-control" name="name" placeholder="{{ __('Name') }}" value="" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center category-block pl-2 pb-1">
                            <div class="col-lg-2 d-flex">
                                ...
                                <input type="checkbox" class="custom-control-input category-check" name="section[]" value="categories" id="categories">
                            ...
                            <div class="col-lg-2 d-flex justify-content-between">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input categories_add" name="section[]" value="categories_add"  id="categories_add">
                            ...
                            <div class="col-lg-2 d-flex justify-content-between">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input categories_update" name="section[]" value="categories_update"  id="categories_update">
                            ...
                            <div class="col-lg-2 d-flex justify-content-between">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input categories_delete" name="section[]" value="categories_delete"  id="categories_delete">
                            ...
                            <div class="col-lg-2 d-flex justify-content-between">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input categories_status" name="section[]" value="categories_status"  id="categories_status">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input sub_categories" name="section[]" value="sub_categories"  id="sub_categories">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input sub_categories_add" name="section[]" value="sub_categories_add"  id="sub_categories_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input sub_categories_edit" name="section[]" value="sub_categories_edit"  id="sub_categories_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input sub_categories_delete" name="section[]" value="sub_categories_delete"  id="sub_categories_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input sub_categories_status" name="section[]" value="sub_categories_status"  id="sub_categories_status">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input services" name="section[]" value="services"  id="services">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input services_add" name="section[]" value="services_add"  id="services_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input services_edit" name="section[]" value="services_edit"  id="services_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input services_delete" name="section[]" value="services_delete"  id="services_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input services_status" name="section[]" value="services_status"  id="services_status">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input services_media" name="section[]" value="services_media"  id="services_media">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input best_services" name="section[]" value="best_services"  id="best_services">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input best_services_add" name="section[]" value="best_services_add"  id="best_services_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input best_services_edit" name="section[]" value="best_services_edit"  id="best_services_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input best_services_delete" name="section[]" value="best_services_delete"  id="best_services_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input best_services_status" name="section[]" value="best_services_status"  id="best_services_status">
                        ...
                        <div class="row justify-content-center pl-2">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input service_specification" name="section[]" value="service_specification"  id="service_specification">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Add') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input service_specification_add" name="section[]" value="service_specification_add"  id="service_specification_add">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Edit') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input service_specification_edit" name="section[]" value="service_specification_edit"  id="service_specification_edit">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Delete') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input service_specification_delete" name="section[]" value="service_specification_delete"  id="service_specification_delete">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Status') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input service_specification_status" name="section[]" value="service_specification_status"  id="service_specification_status">
                          ...
                          <div class="row justify-content-center pl-2">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input service_faq" name="section[]" value="service_faq"  id="service_faq">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Add') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input service_faq_add" name="section[]" value="service_faq_add"  id="service_faq_add">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Edit') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input service_faq_edit" name="section[]" value="service_faq_edit"  id="service_faq_edit">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Delete') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input service_faq_delete" name="section[]" value="service_faq_delete"  id="service_faq_delete">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Status') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input service_faq_status" name="section[]" value="service_faq_status"  id="service_faq_status">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input packages" name="section[]" value="packages"  id="packages">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input packages_add" name="section[]" value="packages_add"  id="packages_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input packages_edit" name="section[]" value="packages_edit"  id="packages_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input packages_delete" name="section[]" value="packages_delete"  id="packages_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input packages_status" name="section[]" value="packages_status"  id="packages_status">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Manage Media') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input packages_media" name="section[]" value="packages_media"  id="packages_media">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input leads" name="section[]" value="leads"  id="leads">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input leads_add" name="section[]" value="leads_add"  id="leads_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input leads_edit" name="section[]" value="leads_edit"  id="leads_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input leads_delete" name="section[]" value="leads_delete"  id="leads_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input leads_status" name="section[]" value="leads_status"  id="leads_status">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input leads_add_user" name="section[]" value="leads_add_user"  id="leads_add_user">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchises" name="section[]" value="franchises"  id="franchises">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchises_add" name="section[]" value="franchises_add"  id="franchises_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchises_edit" name="section[]" value="franchises_edit"  id="franchises_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchises_delete" name="section[]" value="franchises_delete"  id="franchises_delete">
                              <label class="custom-control-label mr-1 slider round" for="franchises_delete">
                              </label>
                            </div>
                          </div>
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchises_status" name="section[]" value="franchises_status"  id="franchises_status">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_user" name="section[]" value="franchise_user"  id="franchise_user">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Edit') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_user_edit" name="section[]" value="franchise_user_edit"  id="franchise_user_edit">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Delete') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_user_delete" name="section[]" value="franchise_user_delete"  id="franchise_user_delete">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input offers" name="section[]" value="offers"  id="offers">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input offers_add" name="section[]" value="offers_add"  id="offers_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input offers_edit" name="section[]" value="offers_edit"  id="offers_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input offers_delete" name="section[]" value="offers_delete"  id="offers_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input offers_status" name="section[]" value="offers_status"  id="offers_status">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input best_offers" name="section[]" value="best_offers"  id="best_offers">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input best_offers_add" name="section[]" value="best_offers_add"  id="best_offers_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input best_offers_edit" name="section[]" value="best_offers_edit"  id="best_offers_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input best_offers_delete" name="section[]" value="best_offers_delete"  id="best_offers_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input best_offers_status" name="section[]" value="best_offers_status"  id="best_offers_status">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input gifts" name="section[]" value="gifts"  id="gifts">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input gifts_add" name="section[]" value="gifts_add"  id="gifts_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input gifts_edit" name="section[]" value="gifts_edit"  id="gifts_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input gifts_delete" name="section[]" value="gifts_delete"  id="gifts_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input gifts_status" name="section[]" value="gifts_status"  id="gifts_status">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input gifts_send" name="section[]" value="gifts_send"  id="gifts_send">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input orders" name="section[]" value="orders"  id="orders">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input orders_view" name="section[]" value="orders_view"  id="orders_view">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input orders_delete" name="section[]" value="orders_delete"  id="orders_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input orders_status" name="section[]" value="orders_status"  id="orders_status">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input orders_invoice" name="section[]" value="orders_invoice"  id="orders_invoice">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_orders_assigned" name="section[]" value="franchise_orders_assigned"  id="franchise_orders_assigned">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input unallocated_orders" name="section[]" value="unallocated_orders"  id="unallocated_orders">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('View') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input unallocated_orders_view" name="section[]" value="unallocated_orders_view"  id="unallocated_orders_view">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input unallocated_orders_delete" name="section[]" value="unallocated_orders_delete"  id="unallocated_orders_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input unallocated_orders_status" name="section[]" value="unallocated_orders_status"  id="unallocated_orders_status">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Franchise Assigned') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input unallocated_orders_assigned" name="section[]" value="unallocated_orders_assigned"  id="unallocated_orders_assigned">
                        ...
                        <!-- <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_assigned" name="section[]" value="franchise_assigned"  id="franchise_assigned">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('view') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_assigned_view" name="section[]" value="franchise_assigned_view"  id="franchise_assigned_view">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input accounts" name="section[]" value="accounts"  id="accounts">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input accounts_income" name="section[]" value="accounts_income"  id="accounts_income">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input accounts_franchise_fees" name="section[]" value="accounts_franchise_fees"  id="accounts_franchise_fees">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              ...
                              <label class="custom-control-label mr-1 slider round" for="accounts_franchise_outstandings">
                              </label>
                            </div>
                          </div>
                          <div class="col-lg-2 d-flex justify-content-start">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input payments" name="section[]" value="payments"  id="payments">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input payments_add" name="section[]" value="payments_add"  id="payments_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input payments_edit" name="section[]" value="payments_edit"  id="payments_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input payments_delete" name="section[]" value="payments_delete"  id="payments_delete">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input credit_plans" name="section[]" value="credit_plans"  id="credit_plans">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input credit_plans_add" name="section[]" value="credit_plans_add"  id="credit_plans_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input credit_plans_edit" name="section[]" value="credit_plans_edit"  id="credit_plans_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input credit_plans_delete" name="section[]" value="credit_plans_delete"  id="credit_plans_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input credit_plans_status" name="section[]" value="credit_plans_status"  id="credit_plans_status">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input credit_Price_edit" name="section[]" value="credit_Price_edit"  id="credit_Price_edit">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input custome_plans" name="section[]" value="custome_plans"  id="custome_plans">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input service_ratings" name="section[]" value="service_ratings"  id="service_ratings">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input service_ratings_add" name="section[]" value="service_ratings_add"  id="service_ratings_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input service_ratings_edit" name="section[]" value="service_ratings_edit"  id="service_ratings_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input service_ratings_delete" name="section[]" value="service_ratings_delete"  id="service_ratings_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input service_ratings_status" name="section[]" value="service_ratings_status"  id="service_ratings_status">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input package_ratings" name="section[]" value="package_ratings"  id="package_ratings">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input package_ratings_add" name="section[]" value="package_ratings_add"  id="package_ratings_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input package_ratings_edit" name="section[]" value="package_ratings_edit"  id="package_ratings_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input package_ratings_delete" name="section[]" value="package_ratings_delete"  id="package_ratings_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input package_ratings_status" name="section[]" value="package_ratings_status"  id="package_ratings_status">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input order_review" name="section[]" value="order_review"  id="order_review">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            {{--<!-- <label class="control-label h6 font-weight-bold">{{ __('Order Detail View') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input order_review_detail_view" name="section[]" value="order_review_detail_view"  id="order_review_detail_view">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input testimonial" name="section[]" value="testimonial"  id="testimonial">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input testimonial_add" name="section[]" value="testimonial_add"  id="testimonial_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input testimonial_edit" name="section[]" value="testimonial_edit"  id="testimonial_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input testimonial_status" name="section[]" value="testimonial_status"  id="testimonial_status">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input slider_list" name="section[]" value="slider_list"  id="slider_list">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input slider_add" name="section[]" value="slider_add"  id="slider_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input slider_edit" name="section[]" value="slider_edit"  id="slider_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input slider_delete" name="section[]" value="slider_delete"  id="slider_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input slider_status" name="section[]" value="slider_status"  id="slider_status">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input aboutus_list" name="section[]" value="aboutus_list"  id="aboutus_list">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input aboutus_add" name="section[]" value="aboutus_add"  id="aboutus_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input aboutus_edit" name="section[]" value="aboutus_edit"  id="aboutus_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input aboutus_delete" name="section[]" value="aboutus_delete"  id="aboutus_delete">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input blog" name="section[]" value="blog"  id="blog">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input blog_add" name="section[]" value="blog_add"  id="blog_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input blog_edit" name="section[]" value="blog_edit"  id="blog_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input blog_delete" name="section[]" value="blog_delete"  id="blog_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input blog_status" name="section[]" value="blog_status"  id="blog_status">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input news_letter" name="section[]" value="news_letter"  id="news_letter">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input send_news_letter" name="section[]" value="send_news_letter"  id="send_news_letter">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input news_letter_delete" name="section[]" value="news_letter_delete"  id="news_letter_delete">
                        ...
                        <div class="row justify-content-center pl-2 ">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input referral_program" name="section[]" value="referral_program"  id="referral_program">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input request_quotes" name="section[]" value="request_quotes"  id="request_quotes">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input request_quotes_delete" name="section[]" value="request_quotes_delete"  id="request_quotes_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input request_quotes_status" name="section[]" value="request_quotes_status"  id="request_quotes_status">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input followups" name="section[]" value="followups"  id="followups">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label h6 font-weight-bold">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input followups_delete" name="section[]" value="followups_delete"  id="followups_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label h6 font-weight-bold">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input followups_status" name="section[]" value="followups_status"  id="followups_status">
                        ...
                        <div class="row justify-content-center pl-2 pb-1">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input contact_list" name="section[]" value="contact_list"  id="contact_list">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input contact_delete" name="section[]" value="contact_delete"  id="contact_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input contact_status" name="section[]" value="contact_status"  id="contact_status">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_services" name="section[]" value="franchise_services"  id="franchise_services">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_services_edit" name="section[]" value="franchise_services_edit"  id="franchise_services_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            {{--<!-- <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_services_delete" name="section[]" value="franchise_services_delete"  id="franchise_services_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            {{--<!-- <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_services_add" name="section[]" value="franchise_services_add"  id="franchise_services_add">
                        ...
                        {{--<!-- <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_packages" name="section[]" value="franchise_packages"  id="franchise_packages">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Add') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_packages_add" name="section[]" value="franchise_packages_add"  id="franchise_packages_add">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Edit') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_packages_edit" name="section[]" value="franchise_packages_edit"  id="franchise_packages_edit">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_packages_delete" name="section[]" value="franchise_packages_delete"  id="franchise_packages_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Manage Media') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_packages_media" name="section[]" value="franchise_packages_media"  id="franchise_packages_media">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_orders" name="section[]" value="franchise_orders"  id="franchise_orders">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('View') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_orders_view" name="section[]" value="franchise_orders_view"  id="franchise_orders_view">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_orders_status" name="section[]" value="franchise_orders_status"  id="franchise_orders_status">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Invoice') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input franchise_orders_invoice" name="section[]" value="franchise_orders_invoice"  id="franchise_orders_invoice">
                        ...
                        {{--<!-- <div class="row justify-content-center pl-2">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_offers" name="section[]" value="franchise_offers"  id="franchise_offers">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Add') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_offers_add" name="section[]" value="franchise_offers_add"  id="franchise_offers_add">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Edit') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_offers_edit" name="section[]" value="franchise_offers_edit"  id="franchise_offers_edit">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Delete') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_offers_delete" name="section[]" value="franchise_offers_delete"  id="franchise_offers_delete">
                          ...
                          <div class="row justify-content-center pl-2">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_timing" name="section[]" value="franchise_timing"  id="franchise_timing">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Add') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_timing_add" name="section[]" value="franchise_timing_add"  id="franchise_timing_add">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Edit') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_timing_edit" name="section[]" value="franchise_timing_edit"  id="franchise_timing_edit">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Delete') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_timing_delete" name="section[]" value="franchise_timing_delete"  id="franchise_timing_delete">
                        ...
                        <div class="row justify-content-center pl-2">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_worker" name="section[]" value="franchise_worker"  id="franchise_worker">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Add') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_worker_add" name="section[]" value="franchise_worker_add"  id="franchise_worker_add">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Edit') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_worker_edit" name="section[]" value="franchise_worker_edit"  id="franchise_worker_edit">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Delete') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_worker_delete" name="section[]" value="franchise_worker_delete"  id="franchise_worker_delete">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              <label class="control-label">{{ __('Status') }} *</label>
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_worker_status" name="section[]" value="franchise_worker_status"  id="franchise_worker_status">
                        ...
                        <div class="row pl-2">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_credits" name="section[]" value="franchise_credits"  id="franchise_credits">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                                <label class="control-label">{{ __('Add') }} *</label>
                                <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                  <input type="checkbox" class="custom-control-input franchise_credits_add" name="section[]" value="franchise_credits_add"  id="franchise_credits_add">
                        ...
                        <div class="row justify-content-center pl-2">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            ...
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input request_list" name="section[]" value="request_list"  id="request_list">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Delete') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input request_delete" name="section[]" value="request_delete"  id="request_delete">
                          ...
                          <div class="col-lg-2 d-flex justify-content-start">
                            <label class="control-label">{{ __('Status') }} *</label>
                            <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                              <input type="checkbox" class="custom-control-input request_status" name="section[]" value="request_status"  id="request_status">
                          ...
                          <!--End code for Request Quotes us-->
                        ...
                        <div class="row pl-2">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_profile" name="section[]" value="franchise_profile"  id="franchise_profile">
                        ...
                        <div class="row justify-content-center pl-2 pb-2">
                            ...
                            <div class="col-lg-2 d-flex justify-content-start">
                              ...
                              <div class="custom-control custom-switch custom-control-inline mb-1 switch ml-auto">
                                <input type="checkbox" class="custom-control-input franchise_account" name="section[]" value="franchise_account"  id="franchise_account">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <button class="addProductSubmit-btn btn btn-dark mr-1" type="submit">{{ __('Create Role') }}</button>
                          </div>
                        </div>
                      </form>
