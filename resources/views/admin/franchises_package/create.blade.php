                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form id="form_franchise_package" method="POST" action="{{ route('franchises-package.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                <input type="text" name="franchises_id" value="{{ $franchises_id }}" hidden>
                                {{--<!-- <div class="form-group">
                                    <div class="form-line">
                                    <label class="form-label">Category</label>
                                        <select name="category_id[]" id="fp_category_id" class="select-category form-control" multiple="multiple">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="form-label">Sub Category</label>
                                        <select name="sub_category_id[]" id="fp_sub_category_id" class="select-subcategory form-control" multiple="multiple">
                                            <option value=""></option>
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        @endif
                                        <p><small class="text-muted">Only allowed jpg, png, jpeg format. Image resolution must be 300*200. Max file size allowed : 5MB</small></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
