                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item">Franchises Package Media
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Franchises Package Media</h4>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 d-flex justify-content-center flex-column">
                                                            <form class="uplogo-form" id="form_media" action="{{ route('franchise.package.edit.media',$media->id) }}" method="POST" enctype="multipart/form-data">
                                                                {{csrf_field()}}    
                                                                @php
                                                                ...
                                                                <div class="set-logo">
                                                                    ...
                                                                    @endif
                                                                    <p><small class="text-muted">Image resolution must be 300*200</small></p>
                                                                </div>
                                                                <hr>
                                                                <div class="submit-area mb-4">  
                                                                    <button type="submit" class="btn btn-info mt-50 submit-btn">Update</button>

                                                                    <a href="javascript:void(0);" data-href="{{ route('franchise.package.media.destroy',$media->id) }}" class="btn btn-danger mt-50  delete">Detete</a>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal fade" id="add_media-model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('franchise.package.add.media') }}" enctype="multipart/form-data">
                                                {{csrf_field()}}
