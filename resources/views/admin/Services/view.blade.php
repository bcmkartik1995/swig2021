                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item">Service Media
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 d-flex justify-content-center flex-column">
                                                            <form class="uplogo-form" id="form_media" action="{{ route('update.media',$media->id) }}" method="POST" enctype="multipart/form-data">
                                                                {{csrf_field()}}    
                                                                @php
                                                                    $ext = strtolower(pathinfo(asset('assets/images/servicemedia/'.$media->media), PATHINFO_EXTENSION));
                                                                @endphp
                                                                <div class="currrent-logo mt-2">
                                                                    @if(in_array($ext, $image_formats))
                                                                        <a class="fancybox">
                                                                            <img class="" src="{{asset('assets/images/servicemedia/'.$media->media)}}" alt="" height="250">
                                                                        </a>
                                                                    @else
                                                                        <a class="fancybox1">
                                                                        <video controls width="100%" height="auto" class="">
                                                                            <source src="{{asset('assets/images/servicemedia/'.$media->media)}}" type="video/mp4" height="250">
                                                                        </video>
                                                                        </a>
                                                                    @endif
                                                                ...
                                                                <div class="set-logo">
                                                                    ...
                                                                    @endif
                                                                    <p><small class="text-muted">Max File size allowed: 10MB</small></p>
                                                                </div>
                                                                <hr>
                                                                <div class="submit-area mb-4">  
                                                                    <button type="submit" class="btn btn-info mt-50 submit-btn">Update</button>

                                                                    {{--<a href="javascript:void(0);" data-href="{{ route('media.destroy',$media->id) }}" class="btn btn-danger mt-50  delete">Detete</a>--}}
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                ...
                                <a class="btn btn-primary mb-2 float-right text-white" data-toggle="modal" data-target="#add_media-modal"><i class="bx bx-plus"></i>&nbsp; Add new</a>

                                <div class="modal fade" id="add_media-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('add.media') }}" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                                <input type="hidden" name="service_id" value="{{ $id }}">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label class="form-label">Media</label>
                                                        <input type="file" class="form-control" name="media" value="{{old('media')}}">
