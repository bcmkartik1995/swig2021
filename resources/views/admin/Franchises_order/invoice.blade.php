                            ...
                            <div class="card invoice-action-wrapper shadow-none border">
                                <div class="card-body">
                                    ...
                                    <div class="invoice-action-btn mb-2">
                                        <a href="{{ route('franchises-invoice-send',$booking->order_id) }}" class="btn btn-primary btn-block invoice-send-btn">
                                    ...
                                    <div class="invoice-action-btn">
                                        <a href="{{ route('franchises-invoice-print',$booking->order_id) }}" class="btn btn-success btn-block">
                                            <span>Download</span>
                                        </a>
                                    </div>
