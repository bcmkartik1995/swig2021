                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item">Edit Slider
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                            <form id="form_subservice" method="POST" action="{{ route('slider.update',$slider->id) }}" enctype="multipart/form-data">
                            {{ method_field('PUT') }}
                            {{ csrf_field() }}
                                <div class="form-group">
                                    <div class="form-line">
                                        <label class="form-label">Title</label>
                                        <input type="text" class="form-control @if($errors->has('title')) is-invalid @endif" name="title" value="{{old('title',$slider->title)}}">
                                        @if($errors->has('title'))
                                ...
                                <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="service_id" id="bs_service_id">
                                            ...
                                            @foreach($services as $service)
                                                <option value="{{ $service->id }}" {{$service->id == old('service_id', $slider->service_id) ? "selected" : ''}}>{{ $service->title }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="file" class="form-control  @if($errors->has('image')) is-invalid @endif" name="image" value="{{old('image',$slider->image)}}">
                                        @if($errors->has('image'))
                                        ...
                                        @if(!empty($slider->image) && File::exists(public_path("assets/images/sliderimage/".$slider->image)))
                                            <div class="mt-25">
                                                <img src="{{ asset('assets/images/sliderimage') }}/{{ $slider->image }}" class="rounded" width="150">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="file" class="form-control @if($errors->has('mobile_image')) is-invalid @endif" name="mobile_image" value="{{old('mobile_image',$slider->mobile_image)}}">
                                        ...
                                        @if(!empty($slider->mobile_image) && File::exists(public_path("assets/images/sliderimage/".$slider->mobile_image)))
                                            <div class="mt-25">
                                                <img src="{{ asset('assets/images/sliderimage') }}/{{ $slider->mobile_image }}" class="rounded" width="150">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <textarea class="form-control @if($errors->has('description')) is-invalid @endif" name="description" id="description">{{old('description',$slider->description)}}</textarea>
