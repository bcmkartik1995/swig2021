                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item">
							<a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
								...
								<span><img class="round" src="{{ asset('assets/admin-assets/app-assets/images/portrait/small/avatar.png') }}" alt="avatar" height="40" width="40"></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right pb-0">
							  ...
							  <a class="dropdown-item mb-25" href="{{ route('admin.password') }}"><i class="bx bxs-lock mr-50"></i>Change Password</a>
                              <div class="dropdown-divider mb-0 mt-0"></div>
                        ...
                        success: function(dataResult){
                            ...
                            $.each(resultData,function(index,row){
                                ...
                                if(row.is_franchise == 1){
                                    route_url =  row.type == 'unallocated service' ? "{{ route('franchise-order') }}" : "{{ route('franchise-order') }}";
                                }else{
                                    route_url =  row.type == 'unallocated service' ? "{{ route('unallocated-orders-view') }}" : "{{ route('orders-view') }}";
                                }
