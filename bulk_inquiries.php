...
if($_REQUEST['keyword'] != "")
{
	...
	$whereClause = " ( cust_name like '%".$searchKeyword."%' or cust_email like '%".$searchKeyword."%' ) and type_of_inquiry = 'B'";
}
else {
	$whereClause = "  type_of_inquiry = 'B'";
}
...
<head>
    ...
    <title>SwigIt | Aphrodisiac Adventures | Bulk Inquiries</title>
...
?>
							 <tr>
								...
								<td  class="tdStyle"><?php echo $purchaseInfoArr[$i]['cust_phone']?></td>
								<td class="tdStyle"><?php echo $purchaseInfoArr[$i]['comments']?>
								</td>
