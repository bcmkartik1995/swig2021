...
$adminUserAccessArr = array('view-all-apps.php', 'add-edit-app.php', 'view-all-menus.php', 'profile.php', 'change-password.php', 'add-edit-menu.php', 'view-all-streams.php', 'add-edit-stream.php', 'view-all-registered-users.php');
