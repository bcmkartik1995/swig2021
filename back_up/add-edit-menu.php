<?php	
	...
	$valParamArray = array("menuName" => 
					...
					"menuType" =>array("type" => "dropDown", "msg" => "Menu Type"),
				);
      ...
      <div class="padding">
		...
		<div class="row main_headlinebox">
			<div class="col-md-6">
				<ul class="breadcrumb_box">
				  ...
				  <li><i class="material-icons">keyboard_arrow_right</i><a href="view-all-menus.php?<?php echo $backBtnURL?>"><span>Menus List</span></a></li>				 
        ...
        <div class="box add_edit_form">
            ...
            <div class="box-header dker">
                <h3><?=$pageTitleTxt?></h3><a href="<?php echo $backBtnURL?>" class="view-all"><i class="material-icons">&#xe02f;</i>View All Menus</a>
            </div>
			<!-- End of box header -->
			<!-- Start of box body -->
            <div class="box-body">
				<form class="form-box" name="add-edit-menu-form" enctype="multipart/form-data" method="post" action="controller/menu-controller.php" onSubmit='return validation(1, <?php echo json_encode($valParamArray); ?>);'>
					...
					<div class="form-group row">
						<label class="col-sm-12 col-md-2 form-control-label"><span class="cla_star">*</span>Menu Type:</label>
						<div class="col-sm-12 col-md-10">
<?php			
...
?>	
					...
					<div class="form-group row">
						<label class="col-sm-12 col-md-2 form-control-label">Is Set Default Menu:</label>
						<div class="col-sm-12 col-md-10">
<?php			
