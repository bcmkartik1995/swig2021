	...
	<div class="padding">
		...
		<div class="row main_headlinebox">
				<div class="col-md-6">
					<ul class="breadcrumb_box">
					  ...
					  <li class="active"><i class="material-icons">keyboard_arrow_right</i><span>Menus List</span></li>
					</ol>
				</div>
				<div class="col-md-6">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>View All Menus of App <span style='color:red'>"<?php echo $appName?>"</span></h3>
<?php
				if ($_SESSION['userDetails']['accountType'] == 'S')
				{
?>
					<a href="add-edit-menu.php?appCode=<?php echo $appCode?>" class="view-all"><i class="material-icons">&#xe02e;</i>Add New Menu</a>
<?php
				}
?>
            </div>
			...
			<div class="search-panel">
				<form class="form-inline" method="post" action='<?php echo $CUR_PAGE_NAME?>'>
					...
					<div class="form-group">
						<label for="search">Menu Type</label>
<?php
            ...
            <div class="table-responsive">
				<table class="table table-striped testimonial_table">
					...
					<tr>
						...
						<th class="text-center">Default Menu</th>
						<th class="text-center" style='display:none;'>Menu Order</th>																				
...
?>
									...
									<form action="controller/menu-controller.php" method="post" class="form-inline" id="<?php echo $frmId4ActionDelete?>">		
										<button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#confirmation_modal" ui-toggle-class="bounce" ui-target="#animate" onClick="javascript:setPopupContent('<?php echo $frmId4ActionDelete?>', ' Deletion', 'Are you sure you want to permanently delete this menu name?');">
