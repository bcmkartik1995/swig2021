...
if (is_array($appInfoArray) && !empty($appInfoArray))
{
	...
	{		
		...
		for ($i = 0; $i < $nunOfRows; $i++)
		{
			...
			$whr = "is15hourReminderSent = 'N' AND streamCode_FK = '$streamCode' AND type = 'L' AND buyerUserCode_FK IS NOT NULL";
...
echo $strCron;
sendEmail("dhara.amish@gmail.com", "Freestyle Cron job 15 minutes", $strCron, "FreeStyle Cron", "no-reply@swigit.com", 'HTML');
?>