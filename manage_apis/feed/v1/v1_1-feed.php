	...
	if (!empty($appInfoArray) && is_array($appInfoArray))
	{
		...
		{			
			...
			for ($i = 0; $i < $numOfRows; $i++)
			{
				...
				$orderBY = "s.isStreamFeatured = 'Y' DESC, sub.subCatName ASC, s.createdOn DESC";
				$subCatInfoArr = $objDBQuery->getRecord(0, array('subCatCode', 'subCatName'), 'tbl_streams s, tbl_subcategories sub', $whereCls, '', '', $orderBY, '');
