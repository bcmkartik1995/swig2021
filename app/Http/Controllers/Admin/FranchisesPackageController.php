...
class FranchisesPackageController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = Package::where('franchises_id',$franchises_id->id)
        ->orderBy('id', 'DESC')
        ->get();
    ...
    public function create()
    {
        ...
        $user_id = Auth::guard('admin')->user()->id;
        $franchises_id = Franchise::where('user_id',$user_id)->pluck('id')->first();
        ...
        ->where('franchise_id',$franchises_id)
        ->get();

        return view('admin.franchises_package.create',compact('franchises_id','cities','services'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.franchises_package.view',compact('package_media','id','image_formats'));
    }
    ...
    public function edit($id)
    {
        ...
        ->where('franchise_id',$package->franchises_id)
        ->get();    

        return view('admin.franchises_package.edit', compact('package','services','package_city','cities','package_service'));
    }
