...
class FranchisesOfferController extends Controller
{
    ...
    public function index()
    {
        ...
        $offers = Offer::where('franchises_id',$franchises_id->id)->get();

        return view('admin.franchises_offer.index',compact('offers'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.franchises_offer.create',compact('categories','users','franchises_id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $offers->franchises_id = $request->input('franchises_id');
        ...
        return redirect('admin/franchises-offer')->with('Insert_Message','Data Created Successfully');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.franchises_offer.edit',compact('offers','categories','subcategory','users','services','users_existing'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/franchises-offer')->with('update_message','Data Updated Successfully');
    }
